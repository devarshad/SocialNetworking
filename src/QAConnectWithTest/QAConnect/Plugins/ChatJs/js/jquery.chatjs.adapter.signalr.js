...
var SignalRServerAdapter = (function () {
    ...
    SignalRServerAdapter.prototype.sendMessage = function (message, done) {
        message.RoomId = 1;
        message.ConversationId = 1;
        this.hubServer.sendMessage(message).done(function () {
            done();
        });
    };

    // sends a typing signal to a room, conversation or user
    SignalRServerAdapter.prototype.sendTypingSignal = function (roomId, conversationId, ToID, done) {
        roomId = 1;
        conversationId = 1;
        this.hubServer.sendTypingSignal(roomId, conversationId, ToID).done(function () {
            done();
        });
    };
...
var SignalRClientAdapter = (function () {
    function SignalRClientAdapter(chatHubClient) {
        ...
        this.hubClient.updateUserList = function (userInfo) {
    ...
    SignalRClientAdapter.prototype.onUpdateUserList = function (handler) {
    ...
    SignalRClientAdapter.prototype.triggerUpdateUserList = function (userInfo) {
