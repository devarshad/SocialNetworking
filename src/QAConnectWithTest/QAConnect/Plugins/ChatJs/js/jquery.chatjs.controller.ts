    ...
    constructor(options: ChatControllerOptions) {
        ...
        this.options.adapter.init(() => {
            ...
            this.options.adapter.client.onMessagesChanged((message: ChatMessageInfo) => {
                if (!this.findPmWindowByOtherUserId(message.FromID)) {
            ...
            friendsWindowOptions.Url = this.options.Url;
            friendsWindowOptions.ProfilePictureUrl = this.options.ProfilePictureUrl;
