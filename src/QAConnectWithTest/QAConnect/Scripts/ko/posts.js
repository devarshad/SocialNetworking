var fileApiUrl = '/api/File/', postApiUrl = '/api/Post/';
...
ko.bindingHandlers.tooltip = {
    init: function (elem, valueAccessor) {
        var spinnerImg = '<center><span><i class="fa fa-5x fa-spinner fa-spin"></i></span></center>';
        var PageID = '', PageType = '';
        $(elem).powerTip(
            {
                placement: 'se',
                ...
                powerTipPreRender: function () {
                    ...
                    PageType = 1;
                    $(this).data('powertip', spinnerImg);
                },
                powerTipRender: function () {
                    // change some content dynamically
                    $('#powerTip').addClass('tooltipEmpty');
                ...
                powerTipOpen: function () {
                    ...
                    $.myAjax({
                        ...
                        data: { 'PageType': PageType, 'PageID': PageID },
                        success: function (data) {
                            vmTooltip.loadPageInfo(data);
                            $('#powerTip').removeClass('tooltipEmpty');
                            $('#powerTip').html($('#containerToolTip').clone(true)[0]);
                        }
                    });
                },
